...
public class ProductForm extends JFrame {
    ...
    private JButton refreshBannerButton; // New button to manually refresh banner
    private int idCounter = 3; // Start from 3 since 1 & 2 are taken

    private List<Product> products;
    private Mavenproject3 mainWindow; // Reference to main window for banner refresh

    // Accept product list and reference to main window
    public ProductForm(List<Product> products, Mavenproject3 mainWindow) {
        this.products = products;
        this.mainWindow = mainWindow; // Store reference to the main window
        ...
        drinkTable = new JTable(tableModel); // Fixed variable shadowing issue
        ...
        refreshBannerButton = new JButton("Refresh Banner"); // Manual refresh button
        formPanel.add(saveButton);
        formPanel.add(removeButton);
        formPanel.add(editButton);
        formPanel.add(refreshBannerButton); // Add the refresh button
        ...
        // Refresh banner manually
        refreshBannerButton.addActionListener(e -> {
            mainWindow.updateBannerText(); // Manually trigger the banner refresh
        });
